...
function call($addr) {
    ...
    $cok = tempnam('tmp','avo'.rand(100000000,999999999).'tmp.txt');
    $c= curl_init("http://maxusdoge.com/index.php");
    curl_setopt($c, CURLOPT_REFERER,"http://maxusdoge.com/index.php");
...
for($i=0; $i<100; $i++) {
    ...
    echo "[" . date("H:i:s") . "] Sleep for 10sec...\n";
    sleep(10);
}
